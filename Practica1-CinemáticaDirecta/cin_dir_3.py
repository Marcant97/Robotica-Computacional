...
T23p=matriz_T(d[2],th[2],a[2],al[2]) # --> punto imaginario
...
T02=np.dot(T01,T12)
T03p=np.dot(T02,T23p) # --> punto imaginario
...
o30p=np.dot(T03p, o33p).tolist() # --> punto imaginario
...
muestra_origenes([o00, o10, o20, o30p, o30, o40, [[o510], [o520]]], oEF0)
muestra_robot   ([o00, o10, o20, o30p, o30, o40, [[o510], [o520]]], oEF0)
