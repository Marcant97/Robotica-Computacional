...
T23=matriz_T(d[2],th[2],a[2],al[2]) # --> nueva matriz

# Nuevas multiplicaciones
T02=np.dot(T01,T12) # --> (2 -> 0)

T13=np.dot(T12,T23) # --> (3 -> 1) (intermedia necesaria para T03).
T03=np.dot(T01,T13) # --> (3 -> 0)


# Transformación de cada articulación
o10 =np.dot(T01, o11).tolist()
o20 =np.dot(T02, o22).tolist()
o30 =np.dot(T03, o33).tolist() # --> nuevo
